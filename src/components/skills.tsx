          ...
          {CATEGORIES.map((category) => {
            ...
            return (
              <motion.div
                ...
                className={`group flex flex-col justify-start rounded-2xl bg-[#070708]/80 border border-white/5 p-6 md:p-8  relative overflow-hidden transition-all duration-500 ${category.borderHover}`}
              >
